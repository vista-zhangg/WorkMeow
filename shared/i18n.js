...
(function (root, factory) {
  ...
  const zh = {
    ...
    'quota.estimateSample': '采样推算',
    'quota.estimateCycle': '本周期推算',
    'quota.estimateCollecting': '积累样本中',
    ...
    'quota.estimateWaiting': '本周期已用 {used}%，达到 5% 后自动预估，随后随用量动态更新。',
    'quota.estimateHistoryPending': '本周期已用 {used}%。暂缺可对应的周期金额；正在补充采样（{percent}% / 5%）。',
    'quota.estimateNote': '按本机用量及 API 价格折算，并非订阅余额或实际账单；模型、缓存和其他设备用量会影响结果。',
