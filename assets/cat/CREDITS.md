...
本项目使用的猫咪 meme GIF 来自「月薪喵」表情包第 1 弹。

> **授权说明：这些素材已获授权用于 WorkMeow 项目及其发布物。素材版权仍归抖音博主 @月薪喵 所有，不纳入 WorkMeow 的 MIT License；本项目授权不自动授予第三方在其他项目中复制、修改或再分发的权利。**
...
版权归抖音博主 **@月薪喵** 所有。公开发布本项目时必须保留本文件及上述署名；授权凭证由项目维护者留存备查。
