...
contextBridge.exposeInMainWorld('pet', {
  ...
  openHideMenu: () => ipcRenderer.send(IPC.OPEN_HIDE_MENU),
  // 渲染进程 -> 主进程
  ...
  repairIntegrations: () => ipcRenderer.invoke(IPC.REPAIR_INTEGRATIONS),
  uninstallIntegrations: () => ipcRenderer.invoke(IPC.UNINSTALL_INTEGRATIONS),
